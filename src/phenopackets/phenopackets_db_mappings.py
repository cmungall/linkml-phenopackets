...
tbl_Age = Table('Age', metadata, 
    Column('age', Text, primary_key=True),
)
tbl_AgeRange = Table('AgeRange', metadata, 
    Column('start', Text, primary_key=True),
    Column('end', Text, primary_key=True),
)
tbl_Biosample = Table('Biosample', metadata, 
...
tbl_ExternalReference = Table('ExternalReference', metadata, 
    Column('id', Text, primary_key=True),
    Column('description', Text, primary_key=True),
)
...
tbl_Gene = Table('Gene', metadata, 
    Column('id', Text, primary_key=True),
    Column('alternate_ids', Text, primary_key=True),
    Column('symbol', Text, primary_key=True),
)
tbl_HgvsAllele = Table('HgvsAllele', metadata, 
    Column('id', Text, primary_key=True),
    Column('hgvs', Text, primary_key=True),
)
tbl_HtsFile = Table('HtsFile', metadata, 
...
tbl_IscnAllele = Table('IscnAllele', metadata, 
    Column('id', Text, primary_key=True),
    Column('iscn', Text, primary_key=True),
)
tbl_MetaData = Table('MetaData', metadata, 
...
tbl_OntologyClass = Table('OntologyClass', metadata, 
    Column('id', Text, primary_key=True),
    Column('label', Text, primary_key=True),
)
tbl_Pedigree = Table('Pedigree', metadata, 
...
tbl_Phenopacket = Table('Phenopacket', metadata, 
    Column('id', Text, primary_key=True),
...
tbl_PhenotypicFeature = Table('PhenotypicFeature', metadata, 
    Column('description', Text, primary_key=True),
...
tbl_Procedure = Table('Procedure', metadata, 
    Column('code', Text, primary_key=True),
    Column('body_site', Text, primary_key=True),
)
tbl_Resource = Table('Resource', metadata, 
    Column('id', Text, primary_key=True),
...
tbl_SpdiAllele = Table('SpdiAllele', metadata, 
    Column('id', Text, primary_key=True),
...
tbl_VcfAllele = Table('VcfAllele', metadata, 
...
mapper_registry.map_imperatively(ExternalReference, tbl_ExternalReference, properties={
})
...
mapper_registry.map_imperatively(PhenotypicFeature, tbl_PhenotypicFeature, properties={
})
